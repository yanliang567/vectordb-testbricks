...
groupid_field = FieldSchema(name="groupid", dtype=DataType.INT64, description="groupid", nullable=True)
device_field = FieldSchema(name="device", dtype=DataType.VARCHAR, max_length=500, description="device", nullable=True)
fname_field = FieldSchema(name="fname", dtype=DataType.VARCHAR, max_length=256, description="fname", nullable=True)
ext_field = FieldSchema(name="ext", dtype=DataType.VARCHAR, max_length=20, description="ext", is_partition_key=True)
ver_field = FieldSchema(name="version", dtype=DataType.VARCHAR, max_length=200, description="data version", nullable=True)
content_field = FieldSchema(name="content", dtype=DataType.VARCHAR, max_length=65535, description="content", nullable=True)
flag_field = FieldSchema(name="flag", dtype=DataType.BOOL, description="flag", nullable=True)
json_field = FieldSchema(name="json_field", dtype=DataType.JSON, max_length=65535, description="json content", nullable=True)
