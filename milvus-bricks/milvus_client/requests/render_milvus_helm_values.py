...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Render Milvus Helm values from a code-managed deploy profile")
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = helm_deploy_topology_summary(profile, values, image=args.image, version=args.version)
