...
from milvus_client.common.data import checksum_fields_for_spec, generate_primary_key_value
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result.status = FAILED
        result.mark_failed("VALIDATION_FAILED", "unexpected error during data validation", error=str(exc))
        result.write(args.output_json)
        return 4
