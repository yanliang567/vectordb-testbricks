...
| 3.0.0 legacy -> 3.0.1 + LoonFFI/Vortex -> 3.0.1 + LoonFFI/Vortex | standalone and cluster workflows | #52340 upgrade path | Enables LoonFFI/Vortex at upgrade; rollback stays on 3.0.1 Vortex and must not return to v3.0.0. |
...
| 3.0.1 legacy -> 3.0.1 + LoonFFI(parquet) -> 3.0.1 legacy | standalone and cluster workflows | LoonFFI-only rollback safety | Isolates the LoonFFI engine from the Vortex format. |
